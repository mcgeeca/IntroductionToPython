...
#
########################################################################
billNyeTheTurtleGuy = rg.SimpleTurtle("turtle")
billNyeTheTurtleGuy.pen = rg.Pen("blue", 30)
billNyeTheTurtleGuy.speed = 10
billNyeTheTurtleGuy.forward(100)
billNyeTheTurtleGuy.left(40)
